...
{
    public partial class HL4001 : Form
    {
        SubBusModel busModel;
        public HL4001(SubBusModel controlBase)
        {
            InitializeComponent();
        ...
        private void Init()
        {
           ...
           // this.txt_Function.Text = busModel.Function;
            ...
            this.cmb_Ch1OutputType.SelectedIndex = busModel.Ch1InoutOrOutputType;
            this.cmb_Ch1Accurary.SelectedIndex = busModel.Ch1Accuracy;

            this.cmb_Ch2OutputType.SelectedIndex = busModel.Ch2InoutOrOutputType;
            this.cmb_Ch2Accurary.SelectedIndex = busModel.Ch2Accuracy;

            this.cmb_Ch3OutputType.SelectedIndex = busModel.Ch3InoutOrOutputType;
            this.cmb_Ch3Accurary.SelectedIndex = busModel.Ch3Accuracy;

            this.cmb_Ch4OutputType.SelectedIndex = busModel.Ch4InoutOrOutputType;
            this.cmb_Ch4Accurary.SelectedIndex = busModel.Ch4Accuracy;
        }
        private void AddEvent()
        {
            this.nmUD_PlugSequence.ValueChanged += UpdateParam;
            this.cmb_Ch1OutputType.SelectedIndexChanged += UpdateParam;
            this.cmb_Ch2OutputType.SelectedIndexChanged += UpdateParam;
            this.cmb_Ch3OutputType.SelectedIndexChanged += UpdateParam;
            this.cmb_Ch4OutputType.SelectedIndexChanged += UpdateParam;
        ...
        private void UpdateParam(object sender, EventArgs e)
        {
            ...
            busModel.Ch1InoutOrOutputType = (short)cmb_Ch1OutputType.SelectedIndex;
            busModel.Ch2InoutOrOutputType = (short)cmb_Ch2OutputType.SelectedIndex;
            busModel.Ch3InoutOrOutputType = (short)cmb_Ch3OutputType.SelectedIndex;
            busModel.Ch4InoutOrOutputType = (short)cmb_Ch4OutputType.SelectedIndex;
