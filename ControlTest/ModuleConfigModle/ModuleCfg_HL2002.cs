...
{
    [Serializable()]
    public class ModuleCfg_HL2002 : ModuleCfgModleBase
    {
        protected override int GuiStringListNumber { get; } = 3;
        public ModuleCfg_HL2002()
        {
        ...
        protected ModuleCfg_HL2002(SerializationInfo info, StreamingContext context) : base(info, context)
        {
