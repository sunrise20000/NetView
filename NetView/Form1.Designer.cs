...
namespace NetView
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.barSubIteExportFile = new DevExpress.XtraBars.BarSubItem();
			...
			this.MenuRecentFiles = new DevExpress.XtraBars.BarSubItem();
			...
			this.MenuConnect = new DevExpress.XtraBars.BarButtonItem();
			this.MenuDisconnect = new DevExpress.XtraBars.BarButtonItem();
			this.MenuCommunicationSetting = new DevExpress.XtraBars.BarButtonItem();
			...
			this.MenuSetup = new DevExpress.XtraBars.BarButtonItem();
			this.MenuStart = new DevExpress.XtraBars.BarButtonItem();
			this.MenuStop = new DevExpress.XtraBars.BarButtonItem();
			...
			this.document1.FloatLocation = new System.Drawing.Point(1079, 569);
			...
			// document3
			// 
			this.document3.Caption = "VarMonitor";
			this.document3.ControlName = "dockPanelVarMonitor";
			this.document3.FloatLocation = new System.Drawing.Point(945, 594);
			...
			this.bar1.FloatLocation = new System.Drawing.Point(176, 431);
			this.bar1.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
            new DevExpress.XtraBars.LinkPersistInfo(this.barLargeButtonItem1),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemOpen),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemSave),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItem4),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItemCut),
			...
			this.barLargeButtonItem1.DropDownControl = this.popupMenu1;
			...
			// barButtonItem24
			// 
			this.barButtonItem24.Caption = "ModbusRTU";
			this.barButtonItem24.Id = 53;
			this.barButtonItem24.Name = "barButtonItem24";
			this.barButtonItem24.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem25
			// 
			this.barButtonItem25.Caption = "PROFIBUS-DP";
			this.barButtonItem25.Id = 54;
			this.barButtonItem25.Name = "barButtonItem25";
			this.barButtonItem25.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem26
			// 
			this.barButtonItem26.Caption = "PROFIBUS-IO";
			this.barButtonItem26.Id = 55;
			this.barButtonItem26.Name = "barButtonItem26";
			this.barButtonItem26.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem27
			// 
			this.barButtonItem27.Caption = "ModbusTCP";
			this.barButtonItem27.Id = 56;
			this.barButtonItem27.Name = "barButtonItem27";
			this.barButtonItem27.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem28
			// 
			this.barButtonItem28.Caption = "EtherCAT";
			this.barButtonItem28.Id = 57;
			this.barButtonItem28.Name = "barButtonItem28";
			this.barButtonItem28.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem30
			// 
			this.barButtonItem30.Caption = "CANopen";
			this.barButtonItem30.Id = 58;
			this.barButtonItem30.Name = "barButtonItem30";
			this.barButtonItem30.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem31
			// 
			this.barButtonItem31.Caption = "DeviceNet";
			this.barButtonItem31.Id = 59;
			this.barButtonItem31.Name = "barButtonItem31";
			this.barButtonItem31.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItemOpen
			// 
			...
			this.barButtonItem_Disconnect.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("barButtonItem_Disconnect.ImageOptions.Image")));
			...
			// barStaticItem4
			// 
			this.barStaticItem4.Caption = "Ver 1.0.0";
			this.barStaticItem4.Id = 36;
			this.barStaticItem4.Name = "barStaticItem4";
			// 
			// barStaticItem5
			// 
			this.barStaticItem5.AllowHtmlText = DevExpress.Utils.DefaultBoolean.True;
			this.barStaticItem5.Caption = "Shanghai Hurry Electronics Tech. Co. Ltd";
			this.barStaticItem5.Id = 38;
			...
			this.barDockControlTop.Margin = new System.Windows.Forms.Padding(8, 9, 8, 9);
			this.barDockControlTop.Size = new System.Drawing.Size(1908, 47);
			// 
			// barDockControlBottom
			// 
			this.barDockControlBottom.CausesValidation = false;
			this.barDockControlBottom.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.barDockControlBottom.Location = new System.Drawing.Point(0, 972);
			this.barDockControlBottom.Manager = this.barManager1;
			this.barDockControlBottom.Margin = new System.Windows.Forms.Padding(8, 9, 8, 9);
			this.barDockControlBottom.Size = new System.Drawing.Size(1908, 27);
			// 
			// barDockControlLeft
			// 
			...
			this.barDockControlLeft.Margin = new System.Windows.Forms.Padding(8, 9, 8, 9);
			this.barDockControlLeft.Size = new System.Drawing.Size(0, 925);
			// 
			// barDockControlRight
			// 
			this.barDockControlRight.CausesValidation = false;
			this.barDockControlRight.Dock = System.Windows.Forms.DockStyle.Right;
			this.barDockControlRight.Location = new System.Drawing.Point(1908, 47);
			this.barDockControlRight.Manager = this.barManager1;
			this.barDockControlRight.Margin = new System.Windows.Forms.Padding(8, 9, 8, 9);
			this.barDockControlRight.Size = new System.Drawing.Size(0, 925);
			// 
			// dockManager1
			// 
			...
			this.bar6.FloatLocation = new System.Drawing.Point(324, 189);
			...
			// barSubItemFile
			// 
			this.barSubItemFile.AllowHtmlText = DevExpress.Utils.DefaultBoolean.True;
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barSubItemNew),
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.barSubIteExportFile),
			...
			this.barSubItemFile.ShowItemShortcut = DevExpress.Utils.DefaultBoolean.True;
			// 
			// barSubItemNew
			// 
			this.barSubItemNew.Caption = "New";
			this.barSubItemNew.Id = 55;
			this.barSubItemNew.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("barSubItemNew.ImageOptions.Image")));
			this.barSubItemNew.ItemShortcut = new DevExpress.XtraBars.BarShortcut((System.Windows.Forms.Keys.Control | System.Windows.Forms.Keys.N));
			...
			this.barSubItemNew.ShowItemShortcut = DevExpress.Utils.DefaultBoolean.True;
			// 
			// barButtonItemNewProject
			// 
			this.barButtonItemNewProject.Caption = "ModbusRTU";
			this.barButtonItemNewProject.Id = 57;
			this.barButtonItemNewProject.Name = "barButtonItemNewProject";
			this.barButtonItemNewProject.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem34
			// 
			this.barButtonItem34.Caption = "PROFIBUS-DP";
			this.barButtonItem34.Id = 58;
			this.barButtonItem34.Name = "barButtonItem34";
			this.barButtonItem34.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem35
			// 
			this.barButtonItem35.Caption = "PROFIBUS-IO";
			this.barButtonItem35.Id = 59;
			this.barButtonItem35.Name = "barButtonItem35";
			this.barButtonItem35.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem36
			// 
			this.barButtonItem36.Caption = "ModbusTCP";
			this.barButtonItem36.Id = 60;
			this.barButtonItem36.Name = "barButtonItem36";
			this.barButtonItem36.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem37
			// 
			this.barButtonItem37.Caption = "EtherCAT";
			this.barButtonItem37.Id = 61;
			this.barButtonItem37.Name = "barButtonItem37";
			this.barButtonItem37.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem38
			// 
			this.barButtonItem38.Caption = "CANopen";
			this.barButtonItem38.Id = 62;
			this.barButtonItem38.Name = "barButtonItem38";
			this.barButtonItem38.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// barButtonItem39
			// 
			this.barButtonItem39.Caption = "DeviceNet";
			this.barButtonItem39.Id = 63;
			this.barButtonItem39.Name = "barButtonItem39";
			this.barButtonItem39.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemNewProject_ItemClick);
			// 
			// MenuOpen
			// 
			...
			this.MenuOpen.ShowItemShortcut = DevExpress.Utils.DefaultBoolean.True;
			...
			this.MenuSave.ShowItemShortcut = DevExpress.Utils.DefaultBoolean.True;
			...
			// barSubIteExportFile
			// 
			this.barSubIteExportFile.Caption = "Output device file";
			this.barSubIteExportFile.Id = 41;
			this.barSubIteExportFile.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "MB excel (.xls)";
			this.barButtonItem7.Id = 44;
			this.barButtonItem7.Name = "barButtonItem7";
			this.barButtonItem7.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemExportFile_ItemClick);
			// 
			// barButtonItem8
			// 
			this.barButtonItem8.Caption = "GSD (.GSD)";
			this.barButtonItem8.Id = 45;
			this.barButtonItem8.Name = "barButtonItem8";
			this.barButtonItem8.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemExportFile_ItemClick);
			// 
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "PN xml (.xml)";
			this.barButtonItem9.Id = 46;
			this.barButtonItem9.Name = "barButtonItem9";
			this.barButtonItem9.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemExportFile_ItemClick);
			// 
			// barButtonItem12
			// 
			this.barButtonItem12.Caption = "MT excel (.xls)";
			this.barButtonItem12.Id = 47;
			this.barButtonItem12.Name = "barButtonItem12";
			this.barButtonItem12.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemExportFile_ItemClick);
			// 
			// barButtonItem13
			// 
			this.barButtonItem13.Caption = "EC xml (.xml)";
			this.barButtonItem13.Id = 48;
			this.barButtonItem13.Name = "barButtonItem13";
			this.barButtonItem13.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemExportFile_ItemClick);
			// 
			// barButtonItem14
			// 
			this.barButtonItem14.Caption = "CA EDS (.eds)";
			this.barButtonItem14.Id = 49;
			this.barButtonItem14.Name = "barButtonItem14";
			this.barButtonItem14.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemExportFile_ItemClick);
			// 
			// barButtonItem15
			// 
			this.barButtonItem15.Caption = "DE EDS (.eds)";
			this.barButtonItem15.Id = 50;
			this.barButtonItem15.Name = "barButtonItem15";
			this.barButtonItem15.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItemExportFile_ItemClick);
			// 
			// MenuRecentFiles
			// 
			...
			// 
			this.MenuCommunicationSetting.Caption = "Com Setting";
			...
			this.barDockControl1.Size = new System.Drawing.Size(1908, 31);
			// 
			// barDockControl2
			// 
			this.barDockControl2.CausesValidation = false;
			this.barDockControl2.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.barDockControl2.Location = new System.Drawing.Point(0, 972);
			this.barDockControl2.Manager = this.barManager2;
			this.barDockControl2.Size = new System.Drawing.Size(1908, 0);
			// 
			// barDockControl3
			// 
			...
			this.barDockControl3.Size = new System.Drawing.Size(0, 894);
			// 
			// barDockControl4
			// 
			this.barDockControl4.CausesValidation = false;
			this.barDockControl4.Dock = System.Windows.Forms.DockStyle.Right;
			this.barDockControl4.Location = new System.Drawing.Point(1908, 78);
			this.barDockControl4.Manager = this.barManager2;
			this.barDockControl4.Size = new System.Drawing.Size(0, 894);
			// 
			// skinBarSubItem1
			// 
			...
			// MenuSetup
			// 
			this.MenuSetup.Id = 51;
			this.MenuSetup.Name = "MenuSetup";
			// 
			// MenuStart
			// 
			this.MenuStart.Id = 52;
			...
			// barButtonItem2
			// 
			this.barButtonItem2.Caption = "Export File";
			...
			// barListItem3
			// 
			this.barListItem3.Caption = "New";
			this.barListItem3.Id = 54;
			this.barListItem3.Name = "barListItem3";
			// 
			// barButtonItem32
			// 
			this.barButtonItem32.Caption = "ModbusRTU";
			this.barButtonItem32.Id = 56;
			...
			this.dockPanelLeft.Margin = new System.Windows.Forms.Padding(8, 6, 8, 6);
			this.dockPanelLeft.Name = "dockPanelLeft";
			this.dockPanelLeft.OriginalSize = new System.Drawing.Size(220, 200);
			this.dockPanelLeft.Size = new System.Drawing.Size(220, 894);
			this.dockPanelLeft.Text = "NetManager";
			// 
			// dockPanel1_Container
			// 
			this.dockPanel1_Container.Location = new System.Drawing.Point(4, 23);
			this.dockPanel1_Container.Margin = new System.Windows.Forms.Padding(8, 6, 8, 6);
			this.dockPanel1_Container.Name = "dockPanel1_Container";
			this.dockPanel1_Container.Size = new System.Drawing.Size(211, 867);
			...
			this.dockPanelRight.Location = new System.Drawing.Point(1544, 78);
			this.dockPanelRight.Margin = new System.Windows.Forms.Padding(8, 6, 8, 6);
			this.dockPanelRight.Name = "dockPanelRight";
			this.dockPanelRight.OriginalSize = new System.Drawing.Size(364, 200);
			this.dockPanelRight.Size = new System.Drawing.Size(364, 894);
			this.dockPanelRight.Text = "DeviceManager";
			// 
			// dockPanel2_Container
			// 
			this.dockPanel2_Container.Controls.Add(this.treeViewDevice);
			this.dockPanel2_Container.Location = new System.Drawing.Point(5, 23);
			this.dockPanel2_Container.Margin = new System.Windows.Forms.Padding(8, 6, 8, 6);
			this.dockPanel2_Container.Name = "dockPanel2_Container";
			this.dockPanel2_Container.Size = new System.Drawing.Size(355, 867);
			this.dockPanel2_Container.TabIndex = 0;
			// 
			// treeViewDevice
			// 
			this.treeViewDevice.Dock = System.Windows.Forms.DockStyle.Fill;
			this.treeViewDevice.Font = new System.Drawing.Font("Tahoma", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.treeViewDevice.Location = new System.Drawing.Point(0, 0);
			this.treeViewDevice.Margin = new System.Windows.Forms.Padding(8, 6, 8, 6);
			this.treeViewDevice.Name = "treeViewDevice";
			this.treeViewDevice.Size = new System.Drawing.Size(355, 867);
			...
			this.dockPanelDown.Location = new System.Drawing.Point(220, 803);
			this.dockPanelDown.Margin = new System.Windows.Forms.Padding(8, 6, 8, 6);
			...
			this.dockPanel3_Container.Size = new System.Drawing.Size(1316, 141);
			...
			this.elementHost1.Size = new System.Drawing.Size(1316, 141);
			...
			this.dockPanelDiagram.ID = new System.Guid("05fd09b3-cadd-4cd6-ac83-aa8e94ef73af");
			this.dockPanelDiagram.Location = new System.Drawing.Point(220, 634);
			...
			this.controlContainer1.Size = new System.Drawing.Size(1318, 558);
			...
			this.elementHost2.Size = new System.Drawing.Size(1318, 558);
			...
			this.dataGridViewVarMonitor.Size = new System.Drawing.Size(1318, 558);
			...
			this.dockPanelMiddle.FloatLocation = new System.Drawing.Point(1079, 569);
			...
			this.dockPanel4_Container.Margin = new System.Windows.Forms.Padding(8, 6, 8, 6);
			this.dockPanel4_Container.Name = "dockPanel4_Container";
			this.dockPanel4_Container.Size = new System.Drawing.Size(1318, 527);
			...
			// barHeaderItem1
			// 
			this.barHeaderItem1.Caption = "Cut";
			this.barHeaderItem1.Id = 31;
			this.barHeaderItem1.ImageOptions.AllowStubGlyph = DevExpress.Utils.DefaultBoolean.True;
			this.barHeaderItem1.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("barHeaderItem1.ImageOptions.Image")));
			this.barHeaderItem1.Name = "barHeaderItem1";
			// 
			// barHeaderItem2
			// 
			this.barHeaderItem2.Caption = "Copy";
			this.barHeaderItem2.Id = 32;
			this.barHeaderItem2.Name = "barHeaderItem2";
			// 
			// barHeaderItem3
			// 
			this.barHeaderItem3.Caption = "Paste";
			this.barHeaderItem3.Id = 33;
			...
			// barSubItem7
			// 
			this.barSubItem7.Caption = "OnLine";
			this.barSubItem7.Id = 6;
			this.barSubItem7.Name = "barSubItem7";
			// 
			// barSubItem8
			// 
			this.barSubItem8.Caption = "Tool";
			...
			// barHeaderItem4
			// 
			this.barHeaderItem4.Caption = "SelectAll";
			this.barHeaderItem4.Id = 35;
			this.barHeaderItem4.Name = "barHeaderItem4";
			// 
			// barButtonItem17
			// 
			this.barButtonItem17.Caption = "ModbusRTU";
			this.barButtonItem17.Id = 43;
			this.barButtonItem17.Name = "barButtonItem17";
			// 
			// barButtonItem18
			// 
			this.barButtonItem18.Caption = "PROFIBUS-DP";
			this.barButtonItem18.Id = 44;
			this.barButtonItem18.Name = "barButtonItem18";
			// 
			// barButtonItem19
			// 
			this.barButtonItem19.Caption = "PROFIBUS-IO";
			this.barButtonItem19.Id = 45;
			this.barButtonItem19.Name = "barButtonItem19";
			// 
			// barButtonItem20
			// 
			this.barButtonItem20.Caption = "ModbusTCP";
			this.barButtonItem20.Id = 46;
			this.barButtonItem20.Name = "barButtonItem20";
			// 
			// barButtonItem21
			// 
			this.barButtonItem21.Caption = "EtherCAT";
			this.barButtonItem21.Id = 47;
			this.barButtonItem21.Name = "barButtonItem21";
			// 
			// barButtonItem22
			// 
			this.barButtonItem22.Caption = "CANopen";
			this.barButtonItem22.Id = 48;
			this.barButtonItem22.Name = "barButtonItem22";
			// 
			// barButtonItem23
			// 
			this.barButtonItem23.Caption = "DeviceNet";
			this.barButtonItem23.Id = 49;
			this.barButtonItem23.Name = "barButtonItem23";
			// 
			// documentManager1
			// 
			this.documentManager1.ContainerControl = this;
			this.documentManager1.MenuManager = this.barManager2;
			...
			// Form1
			// 
			this.Appearance.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(43)))), ((int)(((byte)(166)))), ((int)(((byte)(112)))));
			this.Appearance.Options.UseFont = true;
			this.Appearance.Options.UseForeColor = true;
			this.AutoScaleDimensions = new System.Drawing.SizeF(13F, 29F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(1908, 999);
			this.Controls.Add(this.dockPanelLeft);
			this.Controls.Add(this.dockPanelDown);
			this.Controls.Add(this.dockPanelRight);
			this.Controls.Add(this.dockPanelDiagram);
        ...
        private DevExpress.XtraBars.BarButtonItem MenuLanguage;
        private DevExpress.XtraBars.BarSubItem barSubItem13;
        private DevExpress.XtraBars.BarButtonItem MenuConnect;
        private DevExpress.XtraBars.BarButtonItem MenuDisconnect;
        private DevExpress.XtraBars.BarButtonItem MenuCommunicationSetting;
        private DevExpress.XtraBars.BarButtonItem MenuSetup;
        ...
        private DevExpress.XtraBars.BarSubItem MenuRecentFiles;
        ...
        private DevExpress.XtraBars.BarSubItem barSubIteExportFile;
